...
public class Res extends RESTService {
  ...
  @Api
  @SwaggerDefinition(
      info = @Info(title = "251", version = "0.0.0",
          description = "",
          termsOfService = "",
          contact = @Contact(name = "", email = "CAEAddress@gmail.com") ,
          license = @License(name = "BSD",
              url = "https://github.com/PhilCAEOrg2/microservice-251/blob/master/LICENSE.txt") ) )
  @Path("/")
  ...
  @ApiOperation(value = "getparam", notes = " ")
  public Response getparam(@PathParam("param") String param) {
    ...
    if(res_condition) {
      ...
      return Response.status(HttpURLConnection.HTTP_NOT_FOUND).entity(res.toJSONString()).build();
    }
    return null;
  }
